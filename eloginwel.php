...
<html>
<head>
	<title>Employee Panel | FAST EMS</title>
...
<body>
	...
	<div>
		<!-- <h2>Welcome <?php echo "$empName"; ?> </h2> -->
		    	...
		    	<h2 style="font-family: 'Verdana', sans-serif; color: #5b9aa0; font-size: 25px; text-align: center;">Leaderboard</h2>
    	<table>
    	...
    	<h2 style="font-family: 'Verdana', sans-serif; color: #5b9aa0; font-size: 25px; text-align: center;">Projects Due</h2>
		...
		<h2 style="font-family: 'Verdana', sans-serif; color: #5b9aa0; font-size: 25px; text-align: center;">Salary Status</h2>
		...
		<h2 style="font-family: 'Verdana', sans-serif; color: #5b9aa0; font-size: 25px; text-align: center;">Leave Status</h2>
